This study confirmed that prompt-engineering can meaningfully reduce API costs of LLM-based automated test case generation while keeping 100\% code coverage.
